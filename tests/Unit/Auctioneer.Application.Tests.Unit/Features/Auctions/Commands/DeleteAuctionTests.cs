...
public class DeleteAuctionTests
{
    ...
    {
        _auctionRepository.DeleteAsync(Arg.Any<Guid>()).Returns(Task.CompletedTask);
    ...
    {
        _auctionRepository.DeleteAsync(Arg.Any<Guid>()).Returns(x => throw new Exception("AuctionRepository failed"));
        _eventRepository.CreateAsync(Arg.Any<DomainEvent>()).Returns(Task.CompletedTask);
        _unitOfWork.SaveAsync().Returns(Task.CompletedTask);
